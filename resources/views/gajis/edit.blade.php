...
<form action="{{ route('gajis.update', $gaji->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="select2-container">
                    <select class="form-select select2" name="user_id" id="user_id" required>
                        ...
                        @foreach ($np as $item)
                            <option value="{{ $item->id }}" {{ $gaji->user_id == $item->id ? 'selected' : '' }}>{{ $item->nip }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Bulan:</strong>
                <input type="month" name="bulan" class="form-control" value="{{ $gaji->bulan }}" placeholder="bulan">
                @error('bulan')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Gapok:</strong>
                <input type="text" name="gapok" class="form-control" value="{{ $gaji->gapok }}" placeholder="gapok">
                @error('gapok')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_istri" class="form-control" value="{{ $gaji->tnj_istri }}" placeholder="tnj_istri">
                @error('tnj_istri')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_anak" class="form-control" value="{{ $gaji->tnj_anak }}" placeholder="tnj_anak">
                @error('tnj_anak')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_umum" class="form-control" value="{{ $gaji->tnj_umum }}" placeholder="tnj_umum">
                @error('tnj_umum')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_beras" class="form-control" value="{{ $gaji->tnj_beras }}" placeholder="tnj_beras">
                @error('tnj_beras')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>PPH:</strong>
                <input type="text" name="pph" class="form-control" value="{{ $gaji->pph }}" placeholder="pph">
                @error('pph')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_struktural" class="form-control" value="{{ $gaji->tnj_struktural }}" placeholder="tnj_struktural">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_fungsional" class="form-control" value="{{ $gaji->tnj_fungsional }}" placeholder="tnj_fungsional">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_terpencil" class="form-control" value="{{ $gaji->tnj_terpencil }}" placeholder="tnj_terpencil">
                @error('tnj_terpencil')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="pembulatan" class="form-control" value="{{ $gaji->pembulatan }}" placeholder="pembulatan">
                @error('pembulatan')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_kinerja" class="form-control" value="{{ $gaji->tnj_kinerja }}" placeholder="tnj_kinerja">
                @error('tnj_kinerja')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="tnj_makan" class="form-control" value="{{ $gaji->tnj_makan }}" placeholder="tnj_makan">
                @error('tnj_makan')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="total_gaji" id="total_gaji" class="form-control" value="{{ $gaji->total_gaji }}" placeholder="Total Gaji" readonly>
        </div>
    </div>
